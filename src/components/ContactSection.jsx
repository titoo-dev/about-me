...
export function ContactSection () {
    return <div className="py-32 bg-black-56">
        ...
        <p className="text-lg text-white-52 text-center max-w-lg mx-auto pt-6">Je suis disponible pour des projets freelances, travail à distance ou juste discuter de design, n'hesitez pas à me contacter via</p>
...
<p className="flex justify-center text-lg text-amber-500 text-center max-w-lg mx-auto pt-8">
            <span>RAZAFIMBELO Titosy Manankasina IGGLIA3 n°70</span>
        </p>
    </div>
}
